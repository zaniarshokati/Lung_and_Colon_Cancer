...
class Application:
    ...
    def process(self):
        ...
        (
            ...
            test_generator,
            valid_generator,
        ) = self.data_handler.create_data_generators(train_df, test_df, valid_df)
        ...
        epochs = 1
        history = self.model_handler.train_model(
            train_generator, valid_generator, model, model_name, epochs
        )
        ...
        self.visualizer.print_info(
            test_generator, predictions, print_code, save_dir, subject
        )
